export default function handler(req, res) {
    ...
    if (!data) {
        return res.status(404).send(`
            ...
            <html>
            <head>
                <title>No Configuration Data</title>
                <style>
                    body {
            ...
            <body>
                <div class="error">
                    <h1>No Configuration Data</h1>
                    <p>This link doesn't contain any badge configuration data.</p>
                </div>
            </body>
            </html>
        `);
    ...
    try {
        ...
        const badgeCount = decoded.split('\\n').filter(line => line && !line.startsWith('#')).length;
        ...
        res.status(500).send('Error decoding data: ' + error.message);
    }
}
